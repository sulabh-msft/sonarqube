...
public class CeProcessingSchedulerImpl implements CeProcessingScheduler {
  ...
  public CeProcessingSchedulerImpl(CeProcessingSchedulerExecutorService processingExecutorService, CeQueue ceQueue, ReportTaskProcessor reportTaskProcessor) {
  ...
  public void startScheduling() {
    executorService.scheduleAtFixedRate(new CeWorkerRunnable(ceQueue, reportTaskProcessor), delayForFirstStart, delayBetweenTasks, timeUnit);
  }
